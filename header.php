	   ...
	   <div class="mother-grid-inner">
               <!--header start here-->
				<div class="header-main">
					<div style="padding: 0.8em;  margin-right: 0%; width: 70%;" class="logo-w3-agile">
						<h1 clas><a href="index.php">PREDRAG-HRM</a></h1>
					</div>
						<div class="profile_details w3l" style="float: right; width: 20%;">		
								<ul>
